...
WIFI_DRIVER_MODULE_PATH_REALTEK := "/system/lib/modules/rtl8723ae.ko"
WIFI_DRIVER_MODULE_NAME_REALTEK := "rtl8723ae"
WIFI_DRIVER_MODULE_ARG_REALTEK := "ifname=wlan0 if2name=p2p0"
WIFI_SDIO_IF_DRIVER_MODULE_PATH_REALTEK := "/system/lib/modules/cfg80211_realtek.ko"
TARGET_KERNEL_MODULES        := \
				backports-3.13.2-1/drivers/net/wireless/ath/ath9k/ath9k.ko:system/lib/modules/ath9k.ko \
				backports-3.13.2-1/drivers/net/wireless/ath/ath9k/ath9k_hw.ko:system/lib/modules/ath9k_hw.ko \
				backports-3.13.2-1/drivers/net/wireless/ath/ath9k/ath9k_common.ko:system/lib/modules/ath9k_common.ko \
				backports-3.13.2-1/drivers/net/wireless/ath/ath10k/ath10k_pci.ko:system/lib/modules/ath10k_pci.ko \
				backports-3.13.2-1/drivers/net/wireless/ath/ath10k/ath10k_core.ko:system/lib/modules/ath10k_core.ko \
				backports-3.13.2-1/drivers/net/wireless/ath/ath.ko:system/lib/modules/ath.ko \
				...
				backports-3.13.2-1/drivers/net/wireless/rtlwifi/rtlwifi.ko:system/lib/modules/rtlwifi.ko \
				backports-3.13.2-1/drivers/net/wireless/rtlwifi/rtl_pci.ko:system/lib/modules/rtl_pci.ko \
				...
				backports-3.13.2-1/drivers/bluetooth/bcm203x.ko:system/lib/modules/bcm203x.ko \
				backports-3.13.2-1/drivers/bluetooth/btmrvl_sdio.ko:system/lib/modules/btmrvl_sdio.ko \
				backports-3.13.2-1/drivers/bluetooth/bpa10x.ko:system/lib/modules/bpa10x.ko \
				backports-3.13.2-1/drivers/bluetooth/btmrvl.ko:system/lib/modules/btmrvl.ko \
				backports-3.13.2-1/drivers/bluetooth/hci_vhci.ko:system/lib/modules/hci_vhci.ko \
				backports-3.13.2-1/drivers/bluetooth/ath3k.ko:system/lib/modules/ath3k.ko \
				...
				backports-3.13.2-1/drivers/net/wireless/rtlwifi/rtl8723ae/rtl8723ae.ko:system/lib/modules/rtl8723ae.ko \
